/***********************************************************/
// VERSIONE CON AGGIUNTA DI INPUT
/***********************************************************/
package ex5;
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (scelta == 1) {
				...
				System.out.println("Inserisci il path dove sono presenti i files: ");
				String cartella = sc.nextLine().replace('\'', '\\') + "\\";
//				sc.close();
				System.out.println("Ecco il tuo path " + cartella);

				// Elenchiamo i file nella cartella indicata nella variabile cartella
				File dir = new File(cartella); // dir diventa l'oggetto che gestisce la cartella cartella
												// ("C:\\projects\\JAVA\\wp\\File01\\tests\\")

				File[] files = dir.listFiles(); // file è un array fi File (File[]) in cui dentro ci saranno i file che
												// sono dentro cartella
				// Adesso elenchiamo i file, ma solo i file e con estensione .txt (perchè
				// normalmente mi darà la lista di qualunque file o cartella sotto)
